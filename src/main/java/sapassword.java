 ...
 */
public class sapassword extends javax.swing.JFrame {

    /**
     * Creates new form sapassword
     */
    public sapassword() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Sub-Admin Change password");
        ...
        jLabel18.setText("Change Sub-Admin Password  ");
        getContentPane().add(jLabel18);
        jLabel18.setBounds(40, 30, 410, 60);
        ...
        homebutton.setBounds(440, 30, 80, 50);
        ...
        sumbit.setBounds(160, 370, 200, 50);
            ...
            if(newpass.equals(cnewpass)){
                ...
                while(rs.next()){
                    if(oldpass.equals(rs.getString("password"))){
                        String sql3="UPDATE gymsubadmin SET password='"+newpass+"' WHERE username='"+user+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sapassword.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
